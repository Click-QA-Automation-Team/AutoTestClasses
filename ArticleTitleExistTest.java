...
public class ArticleTitleExistTest extends NecessaryMethodsClass{
    ...
    @Test
    public void attributeExistTest(){
        waitForElementAndClick(
                appiumDriver,
                By.id("org.wikipedia:id/search_container"),
                //By.id("org.wikipedia:id/horizontal_scroll_list_item_image"),
